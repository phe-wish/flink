...
/**
 * Tests for {@link MsgpackFormatFactory}.
 */
public class MsgpackFormatFactoryTest extends TestLogger {
	@Rule
	...
	public void testSeDeSchema() {
		final MsgpackDeserializationSchema expectedDeser = new MsgpackDeserializationSchema(
			ROW_TYPE,
		...
		thrown.expect(containsCause(new UnsupportedOperationException(
			"Msgpack format doesn't support as a sink format yet.")));
	...
	public void testInvalidIgnoreParseError() {
		...
		final Map<String, String> options =
				getModifiedOptions(opts -> opts.put("msgpack.ignore-parse-errors", "abc"));
	...
	private Map<String, String> getAllOptions() {
		...
		options.put("msgpack.fail-on-missing-field", "false");
		options.put("msgpack.ignore-parse-errors", "true");
		return options;
	}
	...
	private static DynamicTableSource createTableSource(Map<String, String> options) {
		return FactoryUtil.createTableSource(
				...
				new Configuration(),
				MsgpackFormatFactoryTest.class.getClassLoader());
	}
